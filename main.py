...
def display_comments(comments_df, article_title):
    ...
    tree = ttk.Treeview(window, columns=["User Name", "Date", "Comment", "Sentiment"], show="headings")
    ...
    for _, row in comments_df.iterrows():
        tree.insert("", "end", values=(row["User Name"], row["Date"], row["Comment"], row["Sentiment"]))
